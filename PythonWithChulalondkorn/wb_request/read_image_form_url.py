...
def read_index(symbols):
    for s in symbols:
        url = "https://www.reuters.wallst.com/enhancements/chartapi/index_chart_api.asp?symbol={}&headerType=quote&width=540&height=249&duration=5".format(s)
...
if __name__ == '__main__':
    ...
    # # webbrowser.open(url)
    # url = "https://www.reuters.wallst.com/enhancements/chartapi/index_chart_api.asp?symbol=.DJI&headerType=quote&width=540&height=249&duration=5"
